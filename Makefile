# This Makefile is for the File::Monitor::Lite extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/File/Monitor/Lite.pm]
#     AUTHOR => q[dryman <dryman@apple.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[File::Monitor::Lite]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/File/Monitor/Lite.pm]
...
MAKE = make
FULLEXT = File/Monitor/Lite
BASEEXT = Lite
PARENT_NAME = File::Monitor
DLBASE = $(BASEEXT)
VERSION_FROM = lib/File/Monitor/Lite.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/File/Monitor/Lite.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/File/Monitor
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/File/Monitor
...
TO_INST_PM = lib/File/Monitor/Lite.pm

PM_TO_BLIB = lib/File/Monitor/Lite.pm \
...
DISTNAME = File-Monitor-Lite
DISTVNAME = File-Monitor-Lite-0.01
...
manifypods : pure_all  \
	lib/File/Monitor/Lite.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/File/Monitor/Lite.pm $(INST_MAN3DIR)/File::Monitor::Lite.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               File-Monitor-Lite' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for blah blah blah' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - dryman <dryman@apple.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>dryman &lt;dryman@apple.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/File/Monitor/Lite.pm blib/lib/File/Monitor/Lite.pm 
